  ...
  for ; l<m.p_fb.NumLines(); l++ {
    ...
    for ; p<LL; p++ {
      ...
      if( c0=='{' || c0=='}' ) {
        ...
        m.state = m.Hi_In_DoubleQuote_to_None
...
func (m *Highlight_JSON) Hi_In_DoubleQuote_to_None( l, p int ) (int,int) {
...
func (m *Highlight_JSON) Hi_In_DoubleQuote_to_Value_Array( l, p int ) (int,int) {

  l,p, m.state = Hi_In_DoubleQuote_Base( l,p, m.p_fb, m.Hi_Value_Array, m.const_style )
...
func (m *Highlight_JSON) Hi_Value_Array( l, p int ) (int,int) {
  m.const_style = HI_DEFINE
  m.state = nil
  ...
  for ; l<m.p_fb.NumLines(); l++ {
    ...
    for ; p<LL; p++ {
      ...
      if( c0 == '{' ) {
        ...
        m.state = m.Hi_In_DoubleQuote_to_Value_Array
